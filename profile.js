          ...
          <ScrollView>
            ...
            <List.Accordion title="Customize fog">
              <List.Item
                ...
                onPress={() => mapSetter("rgba(218, 223, 225, 1)")}
              />
              <List.Item
                title="  Sunshine and LollyPops"
                onPress={() => mapSetter("rgba(225, 223, 142, 0.97)")}
              />
              <List.Item
                title="  Sea Foam"
                onPress={() => mapSetter("rgba(70, 204, 146, 0.88)")}
              />
              <List.Item
                title="  Apocalypse "
                onPress={() => mapSetter("rgba(255, 110, 0, 0.88)")}
              />
              <List.Item
                title="  People eater"
                onPress={() => mapSetter("rgba(107, 62, 202, 0.94)")}
              />
              <List.Item
                title="  Unicorn MilkShake"
            ...
            <Portal>
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => onDeletePress(currentUserId)}
                >
                  {" "}
                  Delete Fog Data
                </Button>
